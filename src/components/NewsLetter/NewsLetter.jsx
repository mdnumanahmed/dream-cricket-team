const NewsLetter = () => {
  return (
    <div className="container mx-auto bg-slate-50 bg-[url('../../../assets/bg-shadow.png')] bg-no-repeat bg-cover bg-center px-5 py-3 lg:px-60 lg:py-24 rounded-3xl ring-2 ring-white ring-offset-[24px] ring-offset-current relative top-48 shadow-xl">
